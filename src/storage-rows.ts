...
export function rowToSessionSummary(row: unknown): SessionSummary {
  ...
  return {
    ...
    harness: (record.harness === "cursor" || record.harness === "vscode" || record.harness === "copilot" || record.harness === "kiro" || record.harness === "claude" || record.harness === "opencode" || record.harness === "mcp" || record.harness === "import") ? record.harness : "codex" as HarnessName,
