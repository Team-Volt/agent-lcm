export function rowToSessionSummary(row) {
    ...
    return {
        ...
        harness: (record.harness === "cursor" || record.harness === "vscode" || record.harness === "copilot" || record.harness === "kiro" || record.harness === "mcp" || record.harness === "import") ? record.harness : "codex",
